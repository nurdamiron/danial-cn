...
const base =
  "inline-flex items-center justify-center tracking-[0.12em] uppercase transition disabled:opacity-40 disabled:cursor-not-allowed focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#0b0b0b]";
